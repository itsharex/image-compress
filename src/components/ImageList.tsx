      ...
      taskQueue.addTask(async () => {
        ...
        try {
          ...
          if (index > taskQueue.maxConcurrent / 2) {
            document.querySelector(`.image-item:nth-child(${index - Math.floor(taskQueue.maxConcurrent / 2)})`)?.scrollIntoView({ behavior: 'smooth' })
          }
    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-dark-400">
      ...
      <div className="flex items-center mt-5 p-3 text-sm">
        ...
        <div className="ml-auto flex items-center">
          ...
          <Dropdown.Button className='w-[min-content]' menu={{
            items: [
